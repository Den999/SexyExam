...
namespace ProgKonsa.Name
{
    class ProgKonsa
    {
        public static void Workshop()
        {
            Constructors.InlineExample.Stub();
            RightTriangle @object = new RightTriangle("Name", 3, 4);
            Shape shape = @object;
            Console.WriteLine(@object.GetInfo());
        ...
        public static void StringsAreImmutable()
        {
            ...
            example = "Example";
            // Здесь возвращается новая строка, начальная остаётся неизменной!
            example.Remove(startIndex: 4);
            Console.WriteLine(example);     // Example
            example = example.Remove(startIndex: 4);
            Console.WriteLine(example);     // Exam
        ...
        public static void FileReadingWriting()
        {
            ...
            string nonExistingPath = "file_does_not_exist";
            Console.WriteLine($"File {nonExistingPath} exists: {File.Exists(nonExistingPath)}");
        ...
        public static void StreamReaderEncodingExample()
        {
            ...
            using (StreamWriter streamWriter = new StreamWriter(outputPath, 
                append: false, System.Text.Encoding.UTF32))
            {
        ...
        internal class FieldsAndAccess
        {
        ...
        class Constructors
        {
            ...
            public class InlineExample
            {
                ...
                public static void Stub() { int k = 0; }
            }
